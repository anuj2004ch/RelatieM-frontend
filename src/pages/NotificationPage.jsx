...
import { ClockIcon, MessageSquareCodeIcon, UserCheckIcon ,BellIcon} from "lucide-react";
import NoNotificationsFound from "../components/NoNotifications.jsx";
          ...
          <div className="card-body p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="badge badge-success">
                <MessageSquareCodeIcon className="h-3 w-3 mr-1" />
                New Friend
              </div>
            </div>
          </div>
